...
const Slug = ({product}) => {
  ...
  {data.map((item)=>{
    return <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={item.img}/>
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 class="text-sm title-font text-gray-500 tracking-widest">{item.title}</h2>
        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{item.slug}</h1>
        <div class="flex mb-4">
        ...
        <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
          <div class="flex">
           ...
           {item.color=='Red' && <button className="border-2 border-gray-300 ml-1 bg-red-500 rounded-full w-6 h-6 focus:outline-none"></button>}
          </div>
